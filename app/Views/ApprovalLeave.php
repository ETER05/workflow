            ...
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><a href="/leave/approve/<?= esc($leave['Leave_ID']) ?>" class="btn btn-success btn-sm">Approve</a>
                        <a href="/leave/reject/<?= esc($leave['Leave_ID']) ?>" class="btn btn-danger btn-sm">Reject</a></td>
                    </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
